  ...
  if ($select->rowCount() == 1) {
        ...
        <td class="eingabe">'.$musikstueck["ID"].'</td>
          ...
          <td class="eingabe"><input type="text" name="JahrAuffuehrung" value="'.$musikstueck["JahrAuffuehrung"].'" size="45" maxlength="80" autofocus="autofocus"></td>
            ...
            <tr> 
            <td class="eingabe"></td> 
            <td class="eingabe"><input type="submit" name="senden" value="Speichern"></td>
          </tr> 
              ...
              <tr> 
              <td class="eingabe">Besetzungen:</td> 
              <td class="eingabe">

               <iframe src="iframe_musikstueck_besetzung.php?MusikstueckID='.$musikstueck["ID"].'" width="400" height="200" frameBorder="0" name="Besetzungen"></iframe>
               <br />
               <a href="insert_musikstueck_besetzung.php?MusikstueckID='.$musikstueck["ID"].'" target="_blank">[Besetzung hinzufügen]</a>
                            </td>
        </tr>               
        </table> 
