...
<label>
  ...
  <td class="form-edit form-edit-col2">
  <textarea name="Bemerkung" rows=2 cols=100 maxlength="1000" oninput="changeBackgroundColor(this)">'.htmlentities($musikstueck->Bemerkung).'</textarea> (max. 1000 Zeichen)
  </td>
  </label>
</tr>
