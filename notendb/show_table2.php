...
$add_link_edit=true; // Bearbeiten-Link anzeigen 
...
$show_insert_link=true; // LInk "Neuen Datensatz einfügen" oben anzeigen 
...
// Falls übergebenes Objekt = Info-View
if (!strpos($object, 'info')===false) {
  $add_link_edit=false; 
  $show_insert_link=false; 
}
