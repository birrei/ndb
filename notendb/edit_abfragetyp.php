...
if ($show_data) {
  ...
  <table class="eingabe"> 
    ...
    <td class="eingabe">'.$abfragetyp->ID.'</td>
    </label>
      </tr> 
    ...
    <tr>    
      ...
      <td class="eingabe"><input type="text" name="Name" value="'.$abfragetyp->Name.'" size="45" maxlength="80" required="required" autofocus="autofocus" oninput="changeBackgroundColor(this)"></td>
      </label>
    </tr> 
