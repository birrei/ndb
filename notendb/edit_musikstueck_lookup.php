...
<tr>
  ...
  <td class="eingabe2 eingabe2_2">    
    ...
    $lookuptyp->Relation = 'musikstueck'; 
...
<form action="edit_musikstueck_lookups.php" method="get">
<tr>
  <td class="eingabe2 eingabe2_1">Besonderheit:</td>
  <td class="eingabe2 eingabe2_2">
  <?php 
      $lookup = new Lookup(); 
      $lookup->LookupTypeRelation='musikstueck';
      $lookup->LookupTypeID=$LookupTypeID; 
      $lookup->ReferenceID=$MusikstueckID; 
      $lookup->print_select(); 
