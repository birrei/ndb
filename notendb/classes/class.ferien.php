...
class Ferien {
  ...
  public string $Title='Ferieneintrag';
  public string $Titles='Ferieneinträge';
  ...
  function insert_row (string $SchuljahrID) {
    ...
    $insert = $this->db->prepare("INSERT INTO ferien 
  ...
  function delete(){
    ...
    $delete = $this->db->prepare("DELETE FROM ferien WHERE ID=:ID"); 
    $delete->bindValue(':ID', $this->ID);  

    try {
      $delete->execute(); 
     $this->info->print_info('Der Ferieneintrag wurde gelöscht.');      
      return true;         
    }
    catch (PDOException $e) {
      $this->info->print_user_error(); 
