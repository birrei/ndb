...
<table class="eingabe"> 
  ...
  <tr>    
    ...
    <td class="eingabe"><input type="text" name="Name" value="'.$strichart->Name.'" size="45" maxlength="80" required="required" autofocus="autofocus" oninput="changeBackgroundColor(this)"></td>
    </label>
  </tr> 
